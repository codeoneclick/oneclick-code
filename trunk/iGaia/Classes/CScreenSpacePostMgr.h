...
{
public:
    enum E_OFFSCREEN_MODE { E_OFFSCREEN_MODE_SIMPLE = 0, E_OFFSCREEN_MODE_REFLECTION,E_OFFSCREEN_MODE_REFRACTION, E_OFFSCREEN_MODE_BLOOM_EXTRACT, E_OFFSCREEN_MODE_BLOOM_COMBINE, E_OFFSCREEN_MODE_BLUR, E_OFFSCREEN_MODE_PRE_EDGE_DETECT_COLOR, E_OFFSCREEN_MODE_EDGE_DETECT, E_OFFSCREEN_MODE_NORMAL_DEPTH, E_OFFSCREEN_MODE_MAX };
protected:
