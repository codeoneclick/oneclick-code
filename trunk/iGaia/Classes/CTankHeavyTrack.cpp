...
CTankHeavyTrack::CTankHeavyTrack(void)
{
...
void CTankHeavyTrack::Load(void)
{
    m_pLeftTrack = (CModel*)CSceneMgr::Instance()->Add_CustomModel("tank_heavy_left_track.mdl", IResource::E_THREAD_BACKGROUND);
    ...
    m_pRightTrack = (CModel*)CSceneMgr::Instance()->Add_CustomModel("tank_heavy_right_track.mdl", IResource::E_THREAD_BACKGROUND);
...
void CTankHeavyTrack::Update(void)
{
    ITankTrack::Update();
}