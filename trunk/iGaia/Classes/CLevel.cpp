...
void CLevel::Load(void)
{
    ...
    m_pLandscape->Set_Texture("layer_01_diffuse.pvr", 4);
    m_pLandscape->Set_Texture("layer_01_normal.pvr",  5);
    ...
    m_pWater->Set_Shader(IResource::E_SHADER_LAMBERT);
    m_pWater->Set_Texture("layer_03_diffuse.pvr", 0);
    
    m_pGrass = (CGrass*)CSceneMgr::Instance()->AddLandscapeGrassModel("grass");
    m_pGrass->Set_Shader(IResource::E_SHADER_LAMBERT);
    m_pGrass->Set_Texture("mod_03.pvr", 0);
}
