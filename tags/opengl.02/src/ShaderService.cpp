...
PFNGLCREATEPROGRAMOBJECTARBPROC  ShaderService::glCreateProgramObjectARB = NULL;
PFNGLDELETEOBJECTARBPROC         ShaderService::glDeleteObjectARB = NULL;
PFNGLUSEPROGRAMOBJECTARBPROC     ShaderService::glUseProgramObjectARB = NULL;
PFNGLCREATESHADEROBJECTARBPROC   ShaderService::glCreateShaderObjectARB = NULL;
PFNGLSHADERSOURCEARBPROC         ShaderService::glShaderSourceARB = NULL;
PFNGLCOMPILESHADERARBPROC        ShaderService::glCompileShaderARB = NULL;
PFNGLGETOBJECTPARAMETERIVARBPROC ShaderService::glGetObjectParameterivARB = NULL;
PFNGLATTACHOBJECTARBPROC         ShaderService::glAttachObjectARB = NULL;
PFNGLGETINFOLOGARBPROC           ShaderService::glGetInfoLogARB = NULL;
PFNGLLINKPROGRAMARBPROC          ShaderService::glLinkProgramARB = NULL;
PFNGLGETUNIFORMLOCATIONARBPROC   ShaderService::glGetUniformLocationARB = NULL;
PFNGLUNIFORM4FARBPROC            ShaderService::glUniform4fARB = NULL;
PFNGLUNIFORM1IARBPROC            ShaderService::glUniform1iARB = NULL;
...
unsigned char *ShaderService::_ReadShaderFile( const char *fileName )
{
...
m3_CgShader* ShaderService::GetShader(std::string value)
{
