...
struct m3_VertexBufferPtr
{
	...
	m3_MultiTextureData *multitextureDataPtr;
	...
	std::map<std::string,m3_ChunkData*> chunkIndecesPtr;
...
struct m3_VertexBufferPtr
{
	...
	m3_NormalData *normalDataPtr;
	m3_TextureCoordData *textureCoordPtr;
	m3_MultiTexData     *multitexDataPtr;
	unsigned int *indecesPtr;
...
enum m3_MeshExtension { MESH_M3 = 0, MESH_3DS , MESH_NONE};
