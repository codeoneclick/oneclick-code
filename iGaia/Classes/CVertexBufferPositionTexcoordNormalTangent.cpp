//
//  CVertexBufferPositionTexcoordNormalTangent.cpp
//  iGaia
//
...
CVertexBufferPositionTexcoordNormalTangent::CVertexBufferPositionTexcoordNormalTangent(unsigned int _iNumVertexes, unsigned int _eMode)
{
...
CVertexBufferPositionTexcoordNormalTangent::~CVertexBufferPositionTexcoordNormalTangent(void)
{
    
}

void CVertexBufferPositionTexcoordNormalTangent::Enable(CShader::E_RENDER_MODE _eRenderMode)
{
    ...
    glEnableVertexAttribArray(pShader->Get_VertexSlot(CShader::E_VERTEX_SLOT_TANGENT));
    glVertexAttribPointer(pShader->Get_VertexSlot(CShader::E_VERTEX_SLOT_TANGENT), 4, GL_UNSIGNED_BYTE, GL_FALSE, k_STRIDE_SIZE, (GLvoid*)iBytesPerVertex);
    iBytesPerVertex += sizeof(glm::u8vec4);
}
...
void CVertexBufferPositionTexcoordNormalTangent::Disable(CShader::E_RENDER_MODE _eRenderMode)
{
    ...
    glDisableVertexAttribArray(pShader->Get_VertexSlot(CShader::E_VERTEX_SLOT_TANGENT));
}