...
private :
	...
	CIntersectController* m_intersectController;
	Camera* m_Camera;
	CLight* m_Light;
	CDummy* m_Character;
	CDummy* m_Landscape;
...
public :
	...
	__forceinline CIntersectController* GetIntersectControllerInstance() { return m_intersectController; }
	void Update(Video::CRenderController::ERenderTexture _value);
