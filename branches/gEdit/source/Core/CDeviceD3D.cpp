...
CDeviceD3D::CDeviceD3D()
{
   ...
   D3DParams.BackBufferWidth  = 300;//CWindow::m_Width;
   D3DParams.BackBufferHeight = 300;//CWindow::m_Height;
   ...
   if(FAILED(m_handle->CreateDevice(D3DADAPTER_DEFAULT, D3DDEVTYPE_HAL, CGlobal::m_HWND,
