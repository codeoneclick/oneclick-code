...
#define STANDART_MODEL "STANDART_MODEL"
    ...
    enum E_SHADER { E_SHADER_COLOR = 0, E_SHADER_TEXTURE, E_SHADER_LAMBERT, E_SHADER_PHONG, E_SHADER_CELL_SHADING, E_SHADER_GOOCH, E_SHADER_RIM_LIGHT, E_SHADER_BLOOM_EXTRACT, E_SHADER_BLUR, E_SHADER_BLOOM_COMBINE, E_SHADER_PARALLAX, E_SHADER_LANDSCAPE,  E_SHADER_UNIT };
