...
void CMovieClip::Load(INode::SResourceParam &_param)
{
    ...
    m_pTexture = static_cast<CTexture*>(CResourceMgr::Instance()->Load("Untitled_default.pvr", IResource::E_TEXTURE_MGR, IResource::E_PVR_PARSER, IResource::E_BACKGROUND_THREAD));
    m_pSequence = static_cast<CSequence*>(CResourceMgr::Instance()->Load("Untitled_default.xml", IResource::E_SEQUENCE_MGR, IResource::E_SEQ_PARSER, IResource::E_BACKGROUND_THREAD));
