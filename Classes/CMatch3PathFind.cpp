...
CMatch3PathFind* CMatch3PathFind::m_pInstance = NULL;

CMatch3PathFind::CMatch3PathFind()
{
    m_pMapWave = NULL;
    m_pMapSource = NULL;
}
...
CMatch3PathFind* CMatch3PathFind::Instance()
{
    if( m_pInstance == NULL )
    {
        m_pInstance = new CMatch3PathFind();
    }
    
    return m_pInstance;
}

void CMatch3PathFind::Clear()
{
...
bool CMatch3PathFind::FindPath(int** _pMapSource, int _iMapCells, int _iMapRows, Vector2d vStartNode, Vector2d vEndNode)
{
...
bool CMatch3PathFind::TracePath()
{
    int pCurrentNode[2]; 
